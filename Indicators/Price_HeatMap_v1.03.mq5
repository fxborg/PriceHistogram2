...
#property indicator_type21 DRAW_COLOR_CANDLES
#property indicator_color21  clrLime,clrWhite
...
//--- indicator buffers mapping
   ...
   string short_name="Price HeatMap v1.03";
...
void setPlotColor(int plot)
  {
   ...
   for(int i=1;i<=13;i++)
     {
      PlotIndexSetInteger(plot,PLOT_LINE_COLOR,n++,toRGB(255,0,255-i*20));
